...
#define HID_USAGE_PAGE16_SINGLE(a)                                             \
  HID_USAGE_PAGE16((a & 0xFF), ((a >> 8) & 0xFF))

static const uint8_t layer_status_hid_report_desc[] = {
    HID_USAGE_PAGE16_SINGLE(CONFIG_ZMK_LAYER_STATUS_USB_HID_USAGE_PAGE),
    HID_USAGE(CONFIG_ZMK_LAYER_STATUS_USB_HID_USAGE),
    HID_COLLECTION(0x01),
